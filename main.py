...
def get_args_parser():
    parser = argparse.ArgumentParser('S-DETR: Accelerating DETR Convergence via Semantic-Aligned Matching', add_help=False)
...
if __name__ == '__main__':
    parser = argparse.ArgumentParser("S-DETR", parents=[get_args_parser()])
